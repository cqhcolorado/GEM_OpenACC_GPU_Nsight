...
!  call MPI_REDUCE(totload,load_tm,1,MPI_REAL8,MPI_SUM,0,MPI_COMM_WORLD,ierr)
  ...
  load_tm=load_tm/numprocs
    ...
    write(*,*),'total_tm',total_tm,'poisson_tm',poisson_tm,'ppush_tm',ppush_tm,'cpush_tm',cpush_tm,'pmove_tm',pmove_tm,'others',total_tm-poisson_tm-ppush_tm-cpush_tm-pmove_tm
